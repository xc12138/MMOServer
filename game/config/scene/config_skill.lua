...
local config = {
	...
	[110010] = {
		skill_id = 110010, target_type = 1, shape = 1, duration = 1000, detail = {
			[1] = {
				condition = {{lv, 1}}, cd = 4000, attack_max_num = 5, damage_rate = 15000, area = 600, 
				desc = [[男角技能1，造成50点伤害，并有10%概率减对方50%防御]], 
				buff = {probability=10000,duration=5000,attr_id=3,value=-5000,is_percent=true}
			},
			[2] = {
				condition = {{lv, 2}}, cd = 4000, attack_max_num = 3, damage_rate = 15000, area = 600, 
	...
	[110011] = {
		skill_id = 110011, target_type = 1, shape = 1, duration = 17000, detail = {
			[1] = {
				condition = {{lv, 1}}, cd = 6000, attack_max_num = 5, damage_rate = 20000, area = 600, 
				desc = [[男角技能2，造成600点伤害同时有50%的概率让对方晕眩3秒]],
				buff = {probability=50000, duration=8000}
			},
			[2] = {
				condition = {{lv, 2}}, cd = 6000, attack_max_num = 5, damage_rate = 22000, area = 700, 
	...
	[110012] = {
		skill_id = 120012, target_type = 1, shape = 1, duration = 1000, detail = {
			[1] = {
				condition = {{lv, 1}}, cd = 8000, attack_max_num = 6, damage_rate = 200000, area = 600, 
	...
	[110013] = {
		skill_id = 110013, target_type = 1, shape = 1, duration = 1000, detail = {
			[1] = {
				condition = {{lv, 1}}, cd = 10000, attack_max_num = 5, damage_rate = 30000, area = 600, 
