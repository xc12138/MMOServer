...
local config = {
	...
	[110010] = {
		skill_id = 110010, target_type = 1, shape = 1, duration = 1000, detail = {
			[1] = {
				condition = {{lv, 1}}, cd = 4000, attack_max_num = 5, damage_rate = 30000, area = 600, 
	...
	[110011] = {
		skill_id = 110011, target_type = 1, shape = 1, duration = 17000, detail = {
			[1] = {
				condition = {{lv, 1}}, cd = 6000, attack_max_num = 5, damage_rate = 50000, area = 600, 
	...
	[110012] = {
		skill_id = 120012, target_type = 1, shape = 1, duration = 1000, detail = {
			[1] = {
				condition = {{lv, 1}}, cd = 8000, attack_max_num = 6, damage_rate = 60000, area = 600, 
	...
	[110013] = {
		skill_id = 110013, target_type = 1, shape = 1, duration = 1000, detail = {
			[1] = {
				condition = {{lv, 1}}, cd = 10000, attack_max_num = 5, damage_rate = 80000, area = 600, 
